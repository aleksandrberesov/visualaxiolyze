...
This file provides foundational mandates and guidance for Gemini CLI when working with code in this repository.
...
- **Project Context**: Instructions in this file are foundational mandates and take absolute precedence over general defaults.
